...
# sparseHessianFD: Because gradients are easy, but Hessians are hard
...
should suffice.  The package is being developed on [Github](www.github.com/braunm/sparseHessianFD), so you can also install from

```
devtools::install_github("braunm/sparseHessianFD")
```
